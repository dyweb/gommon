// Code generated by gommon/noodle from _examples/embed/assets,_examples/embed/third_party DO NOT EDIT.
...
// GetNoodleYangchunMian returns an extracted EmbedBowl generated from _examples/embed/assets
func GetNoodleYangchunMian() (noodle.EmbedBowel, error) {
	...
	dirs := map[string]noodle.EmbedDir{"": {
		FileInfo: noodle.FileInfo{
			FileName:    "assets",
			FileSize:    4096,
			FileMode:    020000000775,
			FileModTime: time.Unix(1523142440, 0),
			FileIsDir:   true,
		},
...
// GetNoodleBieRenJiaDeMian returns an extracted EmbedBowl generated from _examples/embed/third_party
func GetNoodleBieRenJiaDeMian() (noodle.EmbedBowel, error) {
	...
	dirs := map[string]noodle.EmbedDir{"": {
		FileInfo: noodle.FileInfo{
			...
			FileSize:    4096,
			FileMode:    020000000775,
			FileModTime: time.Unix(1535353229, 0),
			FileIsDir:   true,
		},
		Entries: []noodle.FileInfo{{
			FileName:    "huge.js",
