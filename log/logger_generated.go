// Code generated by gommon from logger_generated.go.tmpl DO NOT EDIT.
...
func (l *Logger) Print(args ...interface{}) {
	...
	if !l.source {
		l.h.HandleLog(PrintLevel, time.Now(), fmt.Sprint(args...), "", l.fields, nil)
	} else {
		l.h.HandleLog(PrintLevel, time.Now(), fmt.Sprint(args...), caller(), l.fields, nil)
	}
}
...
func (l *Logger) Printf(format string, args ...interface{}) {
	...
	if !l.source {
		l.h.HandleLog(PrintLevel, time.Now(), fmt.Sprintf(format, args...), "", l.fields, nil)
	} else {
		l.h.HandleLog(PrintLevel, time.Now(), fmt.Sprintf(format, args...), caller(), l.fields, nil)
	}
}
...
func (l *Logger) PrintF(msg string, fields Fields) {
	...
	if !l.source {
		l.h.HandleLog(PrintLevel, time.Now(), msg, "", l.fields, fields)
	} else {
		l.h.HandleLog(PrintLevel, time.Now(), msg, caller(), l.fields, fields)
	}
}
